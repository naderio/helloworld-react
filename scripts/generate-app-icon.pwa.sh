...
width=64 height=64 scale=1 prefix=app generate_image_bitmap

width=192 height=192 scale=1 prefix=app generate_image_bitmap

width=512 height=512 scale=1 prefix=app generate_image_bitmap
